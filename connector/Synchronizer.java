...
//	private miniStreamList streamsFromDb;
     ...
     */
    public void run(catchConnector connector, boolean after_login) throws SQLException {
     ...
     */
    public void run(catchConnector connector) throws SQLException {
     ...
     */
    private void synchronize(catchConnector connector) throws SQLException {
...
//							
     ...
     * @return 
     */
    public List<miniStream> getDataFromServer(catchConnector connector2, Boolean addToDb) throws SQLException {
...
//                     }
            ...
            for (miniStream mS : streamListSv) {
                ...
                if (addToDb) {
                    ...
                    List<catchObject> objList = objectController.getCatchObjectsList();
                    //System.out.println(objList.get(0).getModified_at());
                    objectController.getEditedObjects();
                }
